...
/* Explicit linkage to the low-level USB driver handle */
extern PCD_HandleTypeDef hpcd_USB_DRD_FS;

/**
  * @brief USB Device Interrupt Handler.
  * Maps the startup file's vector directly to the ST USB Core Driver.
  */
void UCPD1_UCPD2_USB_IRQHandler(void)
{
...
/**
  ...
  * Prevents core lockups by clearing and refreshing the watchdog
  * during long hardware initialization delays.
  */
