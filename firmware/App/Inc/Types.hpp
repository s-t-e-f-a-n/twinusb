    ...
    /**
     * @struct SystemConfig
     * @brief Global compile-time or runtime configuration options.
     */
    struct SystemConfig {
        bool autoFailover = true; ///< Automatically switch to the residual host if the active one drops
    };
    ...
    struct SystemStatus {
        ...
        SystemStatus(
            ...
            UpstreamType fault = UpstreamType::NONE,
            Telemetry tel = {},
            SystemConfig cfg = {}
